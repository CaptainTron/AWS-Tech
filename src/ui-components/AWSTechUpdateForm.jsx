...
export default function AWSTechUpdateForm(props) {
  const {
    id: idProp,
    aWSTech: aWSTechModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = aWSTechRecord
      ? { ...initialValues, ...aWSTechRecord }
      : initialValues;
  ...
  const [aWSTechRecord, setAWSTechRecord] = React.useState(aWSTechModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(AWSTech, idProp)
        : aWSTechModelProp;
      setAWSTechRecord(record);
    };
    queryData();
  }, [idProp, aWSTechModelProp]);
  React.useEffect(resetStateValues, [aWSTechRecord]);
  const validations = {
    fname: [{ type: "Required" }],
    lname: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            AWSTech.copyOf(aWSTechRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "AWSTechUpdateForm")}
      {...rest}
    >
      <TextField
        label="Fname"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || aWSTechModelProp)}
